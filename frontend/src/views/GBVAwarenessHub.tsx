...
const POLICY_ITEMS = [
  { icon:Gavel, title:"Gordon College CODI", subtitle:"Code of Internal Discipline and Integrity", description:"The CODI governs student and employee conduct at Gordon College. It establishes the formal complaint process, sanctions for violations, and the procedural rights of all parties. Aligned with RA 11313 and RA 7877.", details:["All GC community members must maintain a safe, respectful, harassment-free environment.","The DEIU is the primary office for receiving, investigating, and resolving GBV and harassment complaints.","Both parties are entitled to due process — the right to be heard and present evidence.","Confidentiality of all parties is maintained at all stages of the process.","Sanctions may include suspension, dismissal, mandatory counseling, or other proportionate measures."] },
  { icon:Ban, title:"Anti-Sexual Harassment Policy", subtitle:"Gordon College — In compliance with RA 7877 & RA 11313", description:"Gordon College maintains a zero-tolerance Anti-Sexual Harassment Policy covering students, faculty, staff, and non-academic personnel in all academic and administrative settings.", details:["Zero-tolerance for any form of sexual harassment within campus premises and official school activities.","Faculty and staff are held to a higher standard due to their position of authority over students.","Peer-to-peer harassment is equally prohibited and actionable under institutional policy and RA 11313.","The DEIU is mandated to act on all complaints within the timeframes prescribed by law.","Annual mandatory seminars on sexual harassment prevention are required for all employees."] },
  { icon:Lock, title:"Data Privacy & Confidentiality Policy", subtitle:"In compliance with RA 10173 — Data Privacy Act", description:"Gordon College handles all complaint data in compliance with the Data Privacy Act (RA 10173). This policy governs how your personal information is collected, stored, accessed, and protected throughout the complaint process.", details:["Only authorized DEIU personnel have access to complaint records and personal data.","Your identity will not be disclosed to the respondent or any third party without explicit written consent.","Complaint records are stored securely and retained only as long as legally necessary.","Unauthorized disclosure of complainant information violates both institutional policy and RA 10173.","You have the right to access your complaint records upon written request to the DEIU."] },
];
